<template>
  ...
  <el-skeleton :loading="loading">
    ...
    <template #template>
      <div class="w-48">
        <el-skeleton-item variant="image" class="h-24 w-48" />
  ...
  <el-dialog v-model="createProjectDialogVisible" title="创建项目">
    ...
    >
      ...
      <el-form-item label="项目描述" prop="description">
        <el-input v-model="createProjectFormData.description" placeholder="项目描述" />
      </el-form-item>
    </el-form>
    <template #footer>
...
import { createDefaultProjectParam, createProjectApi, getProjectListApi } from '@/api/project'
